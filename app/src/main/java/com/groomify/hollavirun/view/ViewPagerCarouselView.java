...
public class ViewPagerCarouselView extends RelativeLayout {
    ...
    private Races [] races;                        // Carousel view background image
     ...
     */
    public void setData(FragmentManager fragmentManager, Races[] races, long carouselSlideInterval, OnPageScrolledListener onPageScrolledListener) {
    ...
    private void initCarousel() {
        ...
        ViewPagerCarouselAdapter viewPagerCarouselAdapter = new ViewPagerCarouselAdapter(fragmentManager, races);
